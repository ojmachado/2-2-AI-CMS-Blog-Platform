...
export default function LoginPage() {
  ...
  const checkEmail = async (e: React.FormEvent) => {
    e.preventDefault();
    setError('');
    // Mock check: simply proceed to password
    setStep('password');
  };
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simula um login bem-sucedido e salva o usuário no storage do navegador
      // para que o restante da aplicação (via AuthContext) reconheça o acesso.
      const mockUser = {
