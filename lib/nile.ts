// NOTA: Este arquivo é nomeado 'nile.ts' por razões históricas.
// O código utiliza exclusivamente o driver serverless do NeonDB (@neondatabase/serverless)
// e não possui qualquer dependência do serviço NileDB.
